...
from ai4materials.models.STEM_CNN_segmentation import predict_value # YBC
from ai4materials.models.STEM_CNN_segmentation import predict_with_uncertainty # YBC
