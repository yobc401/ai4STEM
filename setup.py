...
def main():
    ...
    setup(
        ...
        version="0.1",
        description='supervised learning of STEM data', long_description=long_description,
        ...
        # Author details
        author='Byung Chul, Yeo', author_email='yeo@fhi-berlin.mpg.de',
        ...
        packages=['ai4STEM', 'ai4STEM.models',
                'ai4STEM.utils', 'ai4STEM.dataprocessing' ],
        #packages=find_packages(include=['ai4materials']),

        package_dir={'ai4STEM': 'ai4STEM'},
